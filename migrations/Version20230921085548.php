 ...
 */
final class Version20230921085548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType');
    }
}
